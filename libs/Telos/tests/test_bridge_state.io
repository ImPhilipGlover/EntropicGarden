...
"Testing bridge state persistence issue..." println
...
pingResult := TelosCoreLib call("bridge_ping", "immediate_test", pingBuffer, 256)
"Ping result: " .. pingResult println
"Ping buffer: '" .. pingBuffer .. "'" println

"Step 3: Call status (which uses ping internally)..." println
