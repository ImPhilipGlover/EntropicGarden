...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(SharedMemoryHandle const *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 60), // SharedMemoryHandle const *
/*  2 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(SharedMemoryHandle const *, int, SharedMemoryHandle const *, double)
...
/*  9 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(SharedMemoryHandle const *, void * *)
/* 10 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/* 11 */ _CFFI_OP(_CFFI_OP_POINTER, 15), // void * *
/* 12 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 13 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(SharedMemoryHandle const *, void *)
/* 14 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/* 15 */ _CFFI_OP(_CFFI_OP_POINTER, 62), // void *
/* 16 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 17 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(char *, size_t)
/* 18 */ _CFFI_OP(_CFFI_OP_POINTER, 61), // char *
/* 19 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28), // size_t
/* 20 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 21 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(char const *, SharedMemoryHandle const *, SharedMemoryHandle const *, size_t)
/* 22 */ _CFFI_OP(_CFFI_OP_POINTER, 61), // char const *
...
/* 27 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(int)
/* 28 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/* 29 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 30 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(int64_t, SharedMemoryHandle const *, char const *)
...
/* 35 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(int64_t, char const *)
/* 36 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 23),
/* 37 */ _CFFI_OP(_CFFI_OP_NOOP, 22),
/* 38 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 39 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(size_t, SharedMemoryHandle *)
/* 40 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28),
/* 41 */ _CFFI_OP(_CFFI_OP_POINTER, 60), // SharedMemoryHandle *
/* 42 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 43 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(void *)
/* 44 */ _CFFI_OP(_CFFI_OP_NOOP, 15),
/* 45 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 46 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(void *, char const *, SharedMemoryHandle const *)
/* 47 */ _CFFI_OP(_CFFI_OP_NOOP, 15),
/* 48 */ _CFFI_OP(_CFFI_OP_NOOP, 22),
/* 49 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/* 50 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 51 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // BridgeResult()(void *, char const *, SharedMemoryHandle const *, SharedMemoryHandle const *)
/* 52 */ _CFFI_OP(_CFFI_OP_NOOP, 15),
/* 53 */ _CFFI_OP(_CFFI_OP_NOOP, 22),
/* 54 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/* 55 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/* 56 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 57 */ _CFFI_OP(_CFFI_OP_FUNCTION, 62), // void()(void)
/* 58 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 59 */ _CFFI_OP(_CFFI_OP_ENUM, 0), // BridgeResult
/* 60 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // SharedMemoryHandle
...
_cffi_f_bridge_add_vector(PyObject *self, PyObject *args)
{
  ...
  (void)self; /* unused */
  pyresult = _cffi_from_c_deref((char *)&result, _cffi_type(59));
...
static BridgeResult _cffi_d_bridge_initialize(int x0)
{
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "bridge_ann_search", (void *)_cffi_f_bridge_ann_search, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 3), (void *)_cffi_d_bridge_ann_search },
  { "bridge_clear_error", (void *)_cffi_f_bridge_clear_error, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 57), (void *)_cffi_d_bridge_clear_error },
  ...
  { "bridge_destroy_shared_memory", (void *)_cffi_f_bridge_destroy_shared_memory, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 0), (void *)_cffi_d_bridge_destroy_shared_memory },
  { "bridge_execute_vsa_batch", (void *)_cffi_f_bridge_execute_vsa_batch, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 21), (void *)_cffi_d_bridge_execute_vsa_batch },
  { "bridge_get_last_error", (void *)_cffi_f_bridge_get_last_error, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 17), (void *)_cffi_d_bridge_get_last_error },
  { "bridge_get_slot", (void *)_cffi_f_bridge_get_slot, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 46), (void *)_cffi_d_bridge_get_slot },
  { "bridge_initialize", (void *)_cffi_f_bridge_initialize, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 27), (void *)_cffi_d_bridge_initialize },
  { "bridge_map_shared_memory", (void *)_cffi_f_bridge_map_shared_memory, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 9), (void *)_cffi_d_bridge_map_shared_memory },
  ...
  { "bridge_shutdown", (void *)_cffi_f_bridge_shutdown, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 57), (void *)_cffi_d_bridge_shutdown },
  { "bridge_unmap_shared_memory", (void *)_cffi_f_bridge_unmap_shared_memory, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 13), (void *)_cffi_d_bridge_unmap_shared_memory },
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "$SharedMemoryHandle", 60, _CFFI_F_CHECK_FIELDS,
    sizeof(SharedMemoryHandle), offsetof(struct _cffi_align_typedef_SharedMemoryHandle, y), 0, 3 },
};

static const struct _cffi_enum_s _cffi_enums[] = {
  { "$BridgeResult", 59, _cffi_prim_int(sizeof(BridgeResult), ((BridgeResult)-1) <= 0),
    "BRIDGE_SUCCESS,BRIDGE_ERROR_NULL_POINTER,BRIDGE_ERROR_INVALID_HANDLE,BRIDGE_ERROR_MEMORY_ALLOCATION,BRIDGE_ERROR_PYTHON_EXCEPTION,BRIDGE_ERROR_SHARED_MEMORY,BRIDGE_ERROR_TIMEOUT" },
};

static const struct _cffi_typename_s _cffi_typenames[] = {
  { "BridgeResult", 59 },
  { "IoObjectHandle", 15 },
  { "SharedMemoryHandle", 60 },
};
