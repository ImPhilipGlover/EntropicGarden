...
# Import the CFFI bridge (same as in prototypal_bridge.py)
try:
    from ..telos import _telos_bridge
    lib = _telos_bridge.lib
except ImportError:
    # This should not happen in a properly built system
    raise ImportError("Cannot import CFFI bridge - system not properly built")
