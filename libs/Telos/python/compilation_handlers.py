...
def handle_uvm_object_validation(task_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": True, "message": "create_uvm_object is available"}
    except ImportError:
        return {"success": False, "error": "create_uvm_object not available"}error": "create_uvm_object not available"}