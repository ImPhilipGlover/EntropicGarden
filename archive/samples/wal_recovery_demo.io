...
r1 := RectangleMorph clone do(doString("id := \"rect1\""); moveTo(10,10); resizeTo(40,30))
r2 := RectangleMorph clone do(doString("id := \"rect2\""); moveTo(80,20); resizeTo(50,50))
w addMorph(r1)
w addMorph(r2)
...
r1b := RectangleMorph clone do(doString("id := \"rect1\""))
r2b := RectangleMorph clone do(doString("id := \"rect2\""))
w2 addMorph(r1b)
w2 addMorph(r2b)
