...
"
    ...
    ui := Object clone do(
        ...
        heartbeat := method(n := 1,
            if(Telos hasSlot("world") not, return 0)
            if(Telos world == nil, return 0)
            if(Telos world hasSlot("submorphs") not, return 0)
            writeln("Telos: World heartbeat (submorphs: ", Telos world submorphs size, ")")
            1
        )
    )
