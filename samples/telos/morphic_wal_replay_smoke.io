...
// Build scene
r1 := Lobby getSlot("RectangleMorph") clone do(
	setSlot("id", "rect1"); x = 10; y = 10; width = 80; height = 50
)
r1 setColor(1,0,0,1)
r2 := Lobby getSlot("RectangleMorph") clone do(
	setSlot("id", "rect2"); x = 120; y = 30; width = 60; height = 60
)
r2 setColor(0,0,1,1)
w addMorph(r1)
w addMorph(r2)
...
r1b := Lobby getSlot("RectangleMorph") clone do(setSlot("id", "rect1"))
r2b := Lobby getSlot("RectangleMorph") clone do(setSlot("id", "rect2"))
ww addMorph(r1b)
ww addMorph(r2b)
