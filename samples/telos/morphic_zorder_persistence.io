...
r1 := Lobby getSlot("RectangleMorph") clone do(setSlot("id","z1"); x=20; y=20; width=80; height=40)
r2 := Lobby getSlot("RectangleMorph") clone do(setSlot("id","z2"); x=40; y=30; width=80; height=40)
